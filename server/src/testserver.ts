...
server.dataStore.save(
  new Resource('/api/patients/Strolch', {name: 'Strolch', tierart: 'Hund', rasse: 'Mischling', diagnose: 'Bisswunde', eigentuemerVorname: 'Hans', eigentuemerNachname: 'Iten'}),
  new Resource('/api/patients/Minka', {name: 'Minka', tierart: 'Katze', rasse: 'Siam', diagnose: 'Vergiftung', eigentuemerVorname: 'Maria', eigentuemerNachname: 'Rogenmoser'}),
  new Resource('/api/patients/Blacky', {name: 'Blacky', tierart: 'Pferd', rasse: 'Freiberger', diagnose: 'Stauchung', eigentuemerVorname: 'Peter', eigentuemerNachname: 'Jura'})
);

// Mockdaten für api/journals laden

server.dataStore.save(
  new Resource('/api/journals/Strolch', {name: 'Journal Strolch', 'patient.id': 'Hund', diagnose: 'Bisswunde', startdatum: '01.11.2016', enddatum: '10.11.2016'}),
